...
// --- NEW: Combat DNA Card Component (With 5 Bout-Level Metrics) ---
const CombatDNACard = ({ dna, currentTheme }) => {
  // Default fallbacks
  const [baselines, setBaselines] = useState({
    strikePace: 15.7,        // Bout Total Avg
    grapplingIntensity: 5.6, // Bout Total Avg
    violenceIndex: 0.29,     // KDs+Subs per min
    engagementStyle: 42,     // % of time in control
    finishRate: 52,          // % of fights finishing
    avgFightTime: 10.4       // Avg duration in minutes
  });
