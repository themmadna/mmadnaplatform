...
Last updated: 2026-05-30 (Live-event display fixes + full hardening: ufc_events.ended_at + poller stamp + frontend hide; then time fallback + scraper stamp_event_ended_at + swap-aware poller. Swap-aware poller auto-resolved Song vs Figueiredo's 3 opponent-swap rows in place — no deletion needed.)
Next session: Live-event work complete. Resume Phase C — S-P2-13 indexes (rfs.fight_url, user_votes.fight_id), then S-P2-8 search_path hardening / S-P2-9 anon EXECUTE revokes.
